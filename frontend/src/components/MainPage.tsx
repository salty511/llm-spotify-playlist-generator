...
import LoadingDesc from "./LoadingDesc.tsx";
        ...
        <div className="container">
          <div className="row">
            {albumsToRender.slice(0, 20).map((track: ProcessedTrack) => (
              <div
                key={track.trackId}
                className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6 rounded-0"
              >
                <Album
                  trackInfo={track}
 ...
 */
  ...
  const onClickHandler_Album = useCallback(
    (soundURL: string) => {
  ...
  const handleGeneratePlaylist = async (userInput: string) => {
    ...
    try {
      const playlistResult = await generatePlaylist(
        userInput,
        trackList,
        accessToken
      );
        ...
        <Row className="justify-content-center">
          <Col md={7} lg={7}>
            <div className="text-center mb-5 pt-4">
              ...
              <p className="lead text-muted">
                Create personalized playlists using AI. Just describe your mood
                or activity!
              </p>
            </div>
          </Col>
          <Row className="justify-content-center">
            ...
            <Col md={7} lg={7} className="">
              ...
              <p>
                Hover over album covers to play a preview of song, or add the
                song to the track list, these will be used as inspiration in
                creating your playlist. Remove songs by hovering over them in
                the track list.
              </p>
          ...
          <LoadingDesc loading={loading}></LoadingDesc>
          ...
          <div className="container text-center pb-3">
            <div>
              <button
                ...
                onClick={() => onClickTimeFrame("shortTerm")}
                style={{ margin: "10px" }}
              >
                Short Term
              </button>
              <button
                className="btn btn-outline-info"
                onClick={() => onClickTimeFrame("mediumTerm")}
                style={{ margin: "10px" }}
              >
                Medium Term
              </button>
              <button
                className="btn btn-outline-info"
                onClick={() => onClickTimeFrame("longTerm")}
                style={{ margin: "10px" }}
              >
                Long Term
              </button>
