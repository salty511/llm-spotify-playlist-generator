...
interface storeState {
  ...
  addToTrackList: (name: string, img_url: string | null, track_id: string, artist: string) => void
...
export const useStore = create<storeState>()((set, get) => ({
  ...
  addToTrackList: (name: string, img_url: string | null, track_id: string, artist: string) => set((state) => {
